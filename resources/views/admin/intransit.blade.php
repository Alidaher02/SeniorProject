        ...
        <div class="flex items-center justify-between border-b border-blue-100 bg-blue-50 px-5 py-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400">
                    Monitor shipments currently on their way.
                </p>
            </div>
                            ...
                            <td class="px-5 py-4">
                                ...
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a href="/showAdminShipments/{{ $shipment->id }}"
                                        class="rounded-lg border border-blue-100 bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-600 transition hover:bg-blue-100">
                                        View
                                    </a>
